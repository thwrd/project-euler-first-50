...
int main()
{
    std::vector<std::vector<int>> matrix = {{8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8},
    ...
    // a brute force approach would be to iterate through every value and calculate the product of the adjacent numbers
    // up down and diagonally
    // how can this be improved upon? we certainly wouldn't need to calculate up and down, nor left and right, nor diagonals in both directions
    int max = 0;
    for (int i = 0; i < 17; i++)
    {
        for (int j = 0; j < 17; j++)
